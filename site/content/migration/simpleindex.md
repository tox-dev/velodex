...
If simpleindex covers your need, it is admirably small. The reasons people outgrow it map one-to-one onto what velodex
...
[dependency confusion](@/explanation/indexes.md) only as well as the patterns you remember to write, where a virtual
index's hosted-first shadowing is the default for every name you publish.
...
- simpleindex's explicit routing can send *different projects to different upstreams*; velodex's virtual index resolves
