...
for a name the hosted layer has. [The index model](@/explanation/indexes.md) explains why this ordering is the
...
- See what each team is installing: [monitoring](@/guides/monitor.md)
