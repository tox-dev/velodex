...
read-only, so velodex records the change as a reversible override on the virtual index's hosted layer instead of
...
uploads" panel in the [web UI](@/guides/web-ui.md) drives these same endpoints.
