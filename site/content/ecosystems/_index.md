+++
title = "Ecosystems"
description = "Which packaging formats velodex serves: PyPI and OCI. Every index is a role paired with an ecosystem."
sort_by = "weight"
...
Today velodex ships two ecosystems: PyPI and OCI (container images). The architecture is built so more plug in without
reshaping the core: each new ecosystem is a driver that teaches velodex that format's protocol and artifact rules. The
