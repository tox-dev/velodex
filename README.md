# <img src="assets/icon.svg" width="28" alt=""> velox

A PyPI-compatible read-through cache and private index, written in Rust. Point pip, uv, or twine at velox: it proxies
...
**Documentation: [velox.readthedocs.io](https://velox.readthedocs.io/)** - tutorials, how-to guides, the configuration
