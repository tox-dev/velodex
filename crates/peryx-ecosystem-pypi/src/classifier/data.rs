...
pub(super) const DEPRECATED: [(&str, &str); 8] = [
    (
        "Framework :: Django CMS :: 4.2",
        "is deprecated; use Framework :: Django CMS :: 5.0 instead",
    ),
    ("License :: OSI Approved :: Intel Open Source License", "is deprecated"),
    ("License :: OSI Approved :: Jabber Open Source License", "is deprecated"),
    (
    ...
    ("License :: OSI Approved :: X.Net License", "is deprecated"),
    (
